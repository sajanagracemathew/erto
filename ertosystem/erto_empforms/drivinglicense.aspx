<%@ Page Title="" Language="C#" MasterPageFile="~/erto_empforms/Site3.Master" AutoEventWireup="true" CodeBehind="drivinglicense.aspx.cs" Inherits="ertosystem.erto_empforms.drivinglicense" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <p class="center">
        &nbsp;</p>
    <p class="center">
&nbsp;&nbsp;<span class="auto-style1"><strong> Applications for Driving License</strong></span></p>
<p>
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" CssClass="auto-style2" ForeColor="#333333" GridLines="None" Width="863px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="False">
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Blood Group" DataField="Blood_grp" />
            <asp:BoundField HeaderText="Qualification" DataField="Qual" />
            <asp:BoundField HeaderText="Veh_Type" DataField="Veh_type" />
