...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <td class="auto-style14" colspan="2" style="text-align: center"><strong>RTO Officer Registration</strong></td>
        <td colspan="1">&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td id="lbrtoname" class="auto-style16">Name</td>
    ...
    <tr>
        ...
        <td id="lbrtodob" class="auto-style16">DOB</td>
        <td class="auto-style17">
    ...
    <tr>
        ...
        <td id="lbrtoaddress" class="auto-style16">Address</td>
        <td class="auto-style17">
    ...
    <tr>
        ...
        <td id="lbrtomobile" class="auto-style16">Mobile number</td>
        <td class="auto-style17">
    ...
    <tr>
        ...
        <td id="lbrtodoj" class="auto-style16">Date of Join</td>
        <td class="auto-style17">
    ...
    <tr>
        ...
        <td id="lbrtopassword" class="auto-style16">Password</td>
        <td class="auto-style17">
