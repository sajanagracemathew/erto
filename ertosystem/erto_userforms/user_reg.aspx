...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td style="width: 176px; height: 14px;"></td>
        <td style="width: 185px; height: 14px;"></td>
        <td style="width: 191px; height: 14px;" class="modal-sm"></td>
        <td style="height: 14px; width: 179px;"></td>
        <td style="height: 14px; width: 142px;">&nbsp;</td>
        <td style="height: 14px; width: 178px;">&nbsp;</td>
        <td style="height: 14px">&nbsp;</td>
    </tr>
    <tr>
        <td class="text-center" style="text-align: center; width: 176px;">&nbsp;</td>
        ...
        <td colspan="1" style="width: 179px">&nbsp;</td>
    ...
    <tr>
        <td style="width: 176px; height: 24px">&nbsp;</td>
        ...
        <td style="height: 24px; width: 142px;">&nbsp;</td>
        <td style="height: 24px; width: 178px;">&nbsp;</td>
        <td style="height: 24px">&nbsp;</td>
    </tr>
    <tr>
        <td id="lbname" style="width: 176px; height: 29px;"></td>
        ...
        <td style="height: 29px; width: 142px;">
            Username</td>
        <td style="height: 29px; width: 178px;">
    ...
    <tr>
        <td id="lbdob" style="width: 176px; height: 29px;"></td>
    ...
    <tr>
        <td id="lbdob" style="width: 176px; height: 27px;"></td>
        ...
        <td style="height: 27px; width: 179px;">
            &nbsp;</td>
        <td style="height: 27px; width: 142px;">
            Confirm password</td>
        <td style="height: 27px; width: 178px;">
    ...
    <tr>
        <td id="lbaddress" style="width: 176px; height: 29px;"></td>
    ...
    <tr>
        <td id="lbcity" style="width: 176px; height: 29px;"></td>
    ...
    <tr>
        <td id="lbmobile" style="width: 176px; height: 29px"></td>
    ...
    <tr>
        <td id="lbemail" style="width: 176px; height: 6px;"></td>
        ...
        <td style="height: 6px; width: 179px;">
        ...
        <td style="height: 6px; width: 142px;">
            &nbsp;</td>
        <td style="height: 6px; width: 178px;">
            &nbsp;</td>
        <td style="height: 6px">
            &nbsp;</td>
    </tr>
    <tr>
        <td id="lbphoto" style="width: 176px; height: 27px;"></td>
    ...
    <tr>
        <td id="lbusername" style="width: 176px; height: 29px"></td>
        <td id="lbusername" style="width: 185px; height: 29px">&nbsp;</td>
    ...
    <tr>
        <td id="lbpassword" style="width: 176px; height: 30px;"></td>
        <td id="lbpassword" style="width: 185px; height: 30px;">&nbsp;</td>
    ...
    <tr>
        <td id="lbconfirm" style="width: 176px; height: 20px">&nbsp;</td>
        <td id="lbconfirm" style="width: 185px; height: 20px">&nbsp;</td>
    ...
    <tr>
        ...
        <td style="height: 20px; width: 142px;">&nbsp;</td>
