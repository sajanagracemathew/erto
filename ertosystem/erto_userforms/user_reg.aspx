...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <td style="width: 195px" class="modal-sm">&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="height: 24px; width: 195px"></td>
        <td style="height: 24px"></td>
    </tr>
    <tr>
        <td id="lbname" style="width: 201px; height: 29px;"></td>
        <td id="lbname" style="width: 170px; height: 29px;">
            <asp:Label ID="lbname" runat="server" Text="Name"></asp:Label>
        </td>
        <td style="width: 195px; height: 29px;">
            <asp:TextBox ID="tbname" runat="server" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td id="lbdob" style="width: 170px; height: 29px;">DOB</td>
        <td style="width: 195px; height: 29px;">
            <asp:TextBox ID="tbdob" runat="server" Width="158px" TextMode="Date" ForeColor="Black"></asp:TextBox>
        </td>
        <td style="height: 29px">
    ...
    <tr>
        ...
        <td id="lbdob" style="width: 170px; height: 27px;">
            <asp:Label ID="lbgender" runat="server" Text="Gender"></asp:Label>
        </td>
        <td style="width: 195px; height: 27px;">
    ...
    <tr>
        ...
        <td id="lbaddress" style="width: 170px; height: 29px;">Address</td>
        <td style="width: 195px; height: 29px;">
            <asp:TextBox ID="tbaddress" runat="server" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
        <td style="height: 29px">
    ...
    <tr>
        ...
        <td id="lbcity" style="width: 170px; height: 29px;">City</td>
        <td style="width: 195px; height: 29px;">
            <asp:TextBox ID="tbcity" runat="server" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
        <td style="height: 29px">
    ...
    <tr>
        ...
        <td id="lbmobile" style="width: 170px; height: 29px">Mobile number</td>
        <td style="width: 195px; height: 29px">
            <asp:TextBox ID="tbmobile" runat="server" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
        <td style="height: 29px">
    ...
    <tr>
        <td id="lbemail" style="width: 201px; height: 26px;">&nbsp;</td>
        <td id="lbemail" style="width: 170px; height: 26px;">Email</td>
        <td style="width: 195px; height: 26px;">
            <asp:TextBox ID="tbemail" runat="server" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td id="lbphoto" style="width: 170px; height: 27px;">Photo</td>
        <td style="width: 195px; height: 27px;">
            <asp:FileUpload ID="FileUpload1" runat="server" Width="158px" Height="27px" ForeColor="Black" />
        </td>
        <td style="height: 27px">
    ...
    <tr>
        ...
        <td id="lbusername" style="width: 170px; height: 29px">Username</td>
        <td style="height: 29px; width: 195px">
            <asp:TextBox ID="tbusername" runat="server" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
        <td style="height: 29px">
    ...
    <tr>
        ...
        <td id="lbpassword" style="width: 170px; height: 30px;">Password</td>
        <td style="width: 195px; height: 30px;">
            <asp:TextBox ID="tbpassword" runat="server" TextMode="Password" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td id="lbconfirm" style="width: 170px; height: 20px">Confirm password</td>
        <td style="height: 20px; width: 195px">
            <asp:TextBox ID="tbconfirm" runat="server" TextMode="Password" Width="158px" ForeColor="Black"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td style="width: 170px; height: 20px">&nbsp;</td>
        <td style="height: 20px; width: 195px">
            <asp:Button ID="submit_btn" runat="server" Text="SUBMIT" Width="67px" OnClick="submit_btn_Click" ForeColor="Black" />
        </td>
        <td style="height: 20px">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="height: 31px; width: 201px">&nbsp;</td>
        <td style="height: 31px; width: 170px"></td>
        <td style="height: 31px; width: 195px"></td>
