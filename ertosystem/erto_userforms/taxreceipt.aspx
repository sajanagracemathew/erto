<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="taxreceipt.aspx.cs" Inherits="ertosystem.erto_userforms.taxreceipt" %>
                    ...
                    <td>
                        <asp:Panel ID="Panel1" runat="server" BorderStyle="Double" Width="631px">
                            <table class="auto-style8">
                                <tr>
                                    <td class="auto-style3" colspan="4"><strong>TAX RECEIPT</strong></td>
                                </tr>
